...
#*****************************************************************
#--------------------------------------------------------
#Example 1: Data Analytics using Open-Source Tools
#--------------------------------------------------------
library(koRpus)
library(tm)
library(NLP)
tagged.text <- tokenize("C:/Users/Jeff/Documents/VIT University/Data_Analytics.txt", lang="en")
taggedText(tagged.text)
head(taggedText(tagged.text),n=20)
#--------------------------------------------------------
#Example 2: Data Analytics using Open-Source Tools
#--------------------------------------------------------
library(koRpus)
library(tm)
library(NLP)
tagged.text <- tokenize("C:/Users/Jeff/Documents/VIT University/texts/Predictive1.txt", lang="en")
taggedText(tagged.text)
...
1    Predictive word.kRp         10        word        Word (kRp internal)   NA   NA
2     analytics word.kRp          9        word        Word (kRp internal)   NA   NA
3             —     -kRp          1 punctuation Punctuation (kRp internal)   NA   NA
4     sometimes word.kRp          9        word        Word (kRp internal)   NA   NA
5          used word.kRp          4        word        Word (kRp internal)   NA   NA
6  synonymously word.kRp         12        word        Word (kRp internal)   NA   NA
7          with word.kRp          4        word        Word (kRp internal)   NA   NA
8    predictive word.kRp         10        word        Word (kRp internal)   NA   NA
9      modeling word.kRp          8        word        Word (kRp internal)   NA   NA
10            —     -kRp          1 punctuation Punctuation (kRp internal)   NA   NA
11           is word.kRp          2        word        Word (kRp internal)   NA   NA
12          not word.kRp          3        word        Word (kRp internal)   NA   NA
13   synonymous word.kRp         10        word        Word (kRp internal)   NA   NA
14         with word.kRp          4        word        Word (kRp internal)   NA   NA
15   statistics word.kRp         10        word        Word (kRp internal)   NA   NA
